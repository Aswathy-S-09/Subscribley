    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="social-login">
          {clientIdMissing ? (
            <button type="button" className="btn btn-social btn-google" onClick={() => alert('Google Client ID not set. Add REACT_APP_GOOGLE_CLIENT_ID in .env and restart dev server.') }>
