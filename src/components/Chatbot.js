...
function Chatbot() {
  ...
  async function findAnswer(question) {
    ...
    const url = (process.env.REACT_APP_API_URL || 'http://localhost:5000/api') + '/chat';
    ...
    // up to 2 retries with small backoff
    let lastError;
    ...
    console.warn('Chatbot request failed:', lastError?.message || lastError);
    return "I'm having trouble reaching the server. Please confirm the backend is running and try again.";
  }
