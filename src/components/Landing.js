...
const Landing = ({ onAuthSuccess }) => {
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        setContactSuccess(response.message || 'Thank you for your message! We will get back to you soon.');
        setContactForm({ name: '', email: '', message: '' });
      } else {
        setContactError(response.message || 'Failed to send message. Please try again.');
      }
    } catch (error) {
    ...
    <div className="landing">
            ...
            <div className="contact-card">
              ...
              <ul className="contact-list">
                ...
                <li className="contact-item">
                  ...
                  <span>+91 9443853434</span>
                </li>
                <li className="contact-item">
                  <span className="contact-icon"><MailIcon size={20} /></span>
                  <span>subscriblyinfo@gmail.com</span>
                </li>
              </ul>
      ...
      <footer className="landing-footer dark">
        ...
        <div className="footer-bottom">
          <center><div className="container">© {new Date().getFullYear()} Subscribely. All Rights Reserved.</div></center>
        </div>
      </footer>
    </div>
  );
